...
# s1-handover.tcl made on Jan 12 2018 17:12
#################################################
...
$Network1 portList(0).setPortCaptureFileName "RESULTS\\s1-handover\\Port_1_1_2_capture.cap"
...
set IP_R1 [$eNB_R4 getLowerRelatedRange "IpV4V6Range"]
...
set eNB_R5 [::IxLoad new ixNetEGTPNBRange]

# ixNet objects need to be added in the list before they are configured.
$ENB eNodeBRangeList.appendItem -object $eNB_R5
...
set IP_R6 [$eNB_R5 getLowerRelatedRange "IpV4V6Range"]
...
$testController setResultDir "RESULTS\\s1-handover"

$Traffic1_Network1 setCommunityCaptureParams $Test1 true

$Network1 portList(0).setAnalyzerPartialCapture "False;8191"
