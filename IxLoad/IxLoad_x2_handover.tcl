...
# IxLoad_x2_handover.tcl made on Jan 16 2018 17:47
#################################################
...
set logName "IxLoad_x2_handover"
...
set eNB_R3 [::IxLoad new ixNetEGTPNBRange]

# ixNet objects need to be added in the list before they are configured.
$ENB eNodeBRangeList.appendItem -object $eNB_R3
...
set IP_R1 [$eNB_R3 getLowerRelatedRange "IpV4V6Range"]
...
set eNB_R4 [::IxLoad new ixNetEGTPNBRange]

# ixNet objects need to be added in the list before they are configured.
$ENB eNodeBRangeList.appendItem -object $eNB_R4
...
set IP_R6 [$eNB_R4 getLowerRelatedRange "IpV4V6Range"]

$IP_R6 config \
	-count                                   1 \
	-enableGatewayArp                        false \
	-randomizeSeed                           889016265 \
	-generateStatistics                      false \
	-autoIpTypeEnabled                       false \
	-autoCountEnabled                        false \
	-enabled                                 true \
...
set my_ixNetEGTPUEMobilePathEntry [::IxLoad new ixNetEGTPUEMobilePathEntry]

# ixNet objects need to be added in the list before they are configured!
$UE_R2 mobilityPathList.appendItem -object $my_ixNetEGTPUEMobilePathEntry



$my_ixNetEGTPUEMobilePathEntry config \
	-relocateSgw                             false \
	-_Stale                                  false \
	-nextENodeB                              $eNB_R4 \
	-nextRange                               $eNB_R4 
...
set my_ixNetObjectAssociation [::IxLoad new ixNetObjectAssociation]

# ixNet objects need to be added in the list before they are configured!
$ENB enbAssociationList.appendItem -object $my_ixNetObjectAssociation



$my_ixNetObjectAssociation config \
	-associationType                         0 \
	-_Stale                                  false \
	-sourceObject                            $eNB_R4 \
	-targetObject                            $eNB_R3 
...
$testController setResultDir "RESULTS\\IxLoad_x2_handover"
...
::IxLoad delete $my_ixNetEGTPUEMobilePathEntry

::IxLoad delete $my_ixNetObjectAssociation
